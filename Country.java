...
String[] countryName= {"India","SriLanka","England","SouthAfrica","USA","Pakistan","China"};

int[] noOfStates={29,11,34,45,23,9,12};
String[] listOfCapitals={"New Delhi","Colombo","London","Pretoria","Washington","Islamabada","Bilzing"};
